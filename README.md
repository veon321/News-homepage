...
- **Clean Component Typography & Interactive States**: Controls text scaling, letter spacing, and line heights based on the "Inter" variable font. Implements smooth color transitions (`transition: color 0.2s ease`) for navigation anchors, article titles, and action buttons to enhance UX.
